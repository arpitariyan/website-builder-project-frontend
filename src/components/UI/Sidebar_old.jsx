      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col h-full">
        ...
        <div className="p-4 border-t border-gray-200 space-y-2">
          <button 
            ...
            className="w-full flex items-center gap-3 px-3 py-2 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg transition-all duration-200"
          >
        ...
        <div className="p-4 text-center">
          <p className="text-xs text-gray-400">Version 2.0.0 - AI Enhanced</p>
        </div>
      </div>
